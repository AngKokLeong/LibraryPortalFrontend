...
export const ChangeQuantityOfBook: React.FC<{ book: BookModel, deleteBook: any }> = (props, key) => {
    ...
    async function increaseBookQuantity() {
        ...
        //Since the increase book endpoint return 200 OK then increase the value of the quantity and remaining in frontend
            ...
            <div className='row g-0'>
                <div className='col-md-2'>
                    <div className='d-none d-lg-block'>
                        {
                            props.book.img ? 
                                <img src={"data:image/png;base64," + props.book.img} width='123' height='196' alt='Book' />
                            :
                ...
                <div className='mt-3 col-md-1'>
                    <div className='d-flex justify-content-start'>
                        <button className="m-1 btn btn-md btn-danger" onClick={deleteBook}>Delete Book</button>
                    </div>
                </div>
                <button className='m1 btn btn-md main-color text-white' onClick={increaseBookQuantity}>Add Quantity</button>
                <button className='m1 btn btn-md btn-warning' onClick={decreaseBookQuantity}>Decrease Quantity</button>
            </div>
        </div>
    );
