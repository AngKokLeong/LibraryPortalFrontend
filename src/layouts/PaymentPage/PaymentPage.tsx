...
import PaymentInformationRequestModel from '../../models/PaymentInformationRequestModel';
...
export const PaymentPage = () => {
    ...
    async function checkOut() {
        ...
        const paymentInfo = new PaymentInformationRequestModel(Math.round(fees * 100), 'USD', authState?.accessToken?.claims.sub);
